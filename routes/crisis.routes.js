...
router.post('/api/crisis', async (req, res) => {
    console.log('dddd');
...
router.get('/api/crisis', async (req, res) => {
    try {
...
// GET single crisis
router.get('/api/crisis/:id', async (req, res) => {
    const { id } = req.params;
    try {
...
router.put('/api/crisis/:id', async (req, res) => {
...
router.delete('/api/crisis/:id', async (req, res) => {
    const { id } = req.params;
    try {
        const result = await pool.query(
